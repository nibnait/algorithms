...
//        MyClassLoader classLoader = new MyClassLoader(ClassLoader.getSystemClassLoader().getParent());
        classLoader.setRoot("/Users/nibnait/github/algorithms/src/main/java/os/jvm/classloader/自定义类加载器");

        Class<?> clz = Class.forName("os.jvm.classloader.自定义类加载器.LoadDemo", true, classLoader);
