...
## 窗口内最大值或最小值的更新结构
窗口，左->右，  
如果按 大->小 排，求的是每个窗口的最大值
如果按 小->大 排，求的是每个窗口的最小值

 - [H239_滑动窗口最大值](./LeetCode/code200/H239_滑动窗口最大值.java)
 - [M134_加油站](./LeetCode/code100/M134_加油站.java)


### 单调栈
 - [E496_下一个更大元素1](./LeetCode/code400/E496_下一个更大元素1.java)
 - [M503_下一个更大元素2](./LeetCode/code500/M503_下一个更大元素2.java)
 - [M739_每日温度](./LeetCode/code700/M739_每日温度.java)
...
## 并查集
 - [M200_岛屿数量](./LeetCode/code200/M200_岛屿数量.java)
 - [M547_省份数量](./LeetCode/code500/M547_省份数量.java)
